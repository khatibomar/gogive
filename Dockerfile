...
# Start app
CMD ${APP_PATH} -port ${GO_PORT} -env ${GO_ENV} -db-max-open-conns ${GO_DB_MAX_OPEN_CONNS} -db-max-idle-conns ${GO_DB_MAX_IDLE_CONNS} -db-max-idle-time ${GO_DB_MAX_IDLE_TIME} -limiter-rps=${GO_RATE_LIMITER_RPS} -limiter-burst=${GO_RATE_LIMITER_BURST} -limiter-enabled=${GO_RATE_LIMITER_ENABLED}
